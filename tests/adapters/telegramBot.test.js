  ...
  test("skills command lists discovered skills from configured paths and generated folders", async () => {
    ...
    expect(logger.debug).toHaveBeenCalledWith(
      {
        ...
        skillCount: 2,
        skillScopes: ["project"],
        skillSources: ["config-path", "opencode-remote-generated"],
      },
    ...
    expect(reply).toHaveBeenCalledWith(
      [
        ...
        "",
        "Project skills",
        "1. project-helper - Use when helping this project.",
        "",
        "Generated by OpenCode Remote",
        "2. image-style-coach - Use when improving image prompts.",
        "",
