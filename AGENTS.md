...
- Gateway startup and `/skills` refresh install bundled skills as project-local skills and clean up the legacy `.opencode/agent/opencode-remote-meme.md` path if present.
